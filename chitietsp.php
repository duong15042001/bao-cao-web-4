        ...
        <div class="col-md-10">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title" style="color:black;font-size:21px">Chi tiết sản phẩm
                    </h3>
                </div>
                    ...
                    <div class="media">
                        ...
                        <div class="media-body " style="padding-left:20px">
                            ...
                            <form action="./giohang.php" method="get">
                                ...
                                <p></p>
                                <p>
                                    <button style="width:100px; font-size: 15px" type="submit"
                                        class="btn btn-warning btn-lg">Mua</button>
                                </p>
                            </form>
                        </div>
                    </div>
