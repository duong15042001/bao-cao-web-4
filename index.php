...
$new_product = mysqli_query($conn, "SELECT * from sanpham where `show` = 1 ORDER BY `id` DESC LIMIT 6");//sắp xếp sản phẩm mới nhất
?>
...
<div class="container">
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title" style="color:black;font-size:21px">Danh mục</h3>
                </div>
        ...
        <div class="col-md-9">
            ...
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title" style="color:black;font-size:21px">Sản phẩm mới nhất</h3>
                </div>
                <div class="panel-body">
