        ...
        <div class="col-md-10">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title" style="color:black;font-size:21px">Trang giỏ hàng
                    </h3>
                </div>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="6" class="text-center bg-info" style="font-size:21px">
            ...
            <div class="panel text-center">
                <div class="panel-heading">
                    <h3 class="panel-title ">
                        <a href="./thanhtoan.php" class="btn btn-secondary text-center" style="font-size:14px; background-color: #434343;color: white;width: 170px;padding-top: 10px;
